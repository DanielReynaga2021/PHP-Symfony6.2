 ...
 * Tv
 *
 * @ORM\Table(name="tv", indexes={@ORM\Index(name="FK_tv_director", columns={"director_id"})})
...
class Tv
{
     ...
     *
     * @ORM\ManyToMany(targetEntity="Actor", mappedBy="tv")
     */
    private $actor = array();
     ...
     * @var \Doctrine\Common\Collections\Collection
     *
     * @ORM\ManyToMany(targetEntity="Genre", inversedBy="tv")
     * @ORM\JoinTable(name="ref_tv_genre",
     *   joinColumns={
